...
class RNBitStreamTests: XCTestCase {
    ...
    func testReadWriteCharValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.charValue == charValue, "Result is not equal to initial char value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteUnsignedCharValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.unsignedCharValue == unsignedCharValue, "Result is not equal to initial unsigned char value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteShortValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.shortValue == shortValue, "Result is not equal to initial short value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteUnsignedShortValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.unsignedShortValue == unsignedShortValue, "Result is not equal to initial unsigned short value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteIntValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.intValue == intValue, "Result is not equal to initial int value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteUnsignedIntValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.unsignedIntValue == unsignedIntValue, "Result is not equal to initial unsigned int value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteLongValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.longValue == longValue, "Result is not equal to initial long value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteUnsignedLongValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.unsignedLongValue == unsignedLongValue, "Result is not equal to initial unsigned long value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteLongLongValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.longLongValue == longLongValue, "Result is not equal to initial long long value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteUnsignedLongLongValue() {
        ...
        do {
            ...
            XCTAssertNotNil(result, "Result is nil")
            XCTAssert(result?.unsignedLongLongValue == unsignedLongLongValue, "Result is not equal to initial unsigned long long value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
    ...
    func testReadWriteMultipleValues() {
        ...
        let shortValue: CShort = 6532
        let bytes: [UInt8] = [0x12, 0x54, 0x44, 0x64]
        let dataValue = NSData(bytes: bytes, length: bytes.count)
        let longValue: CLong = 23433577896
        ...
        do {
            ...
            XCTAssert(shortResult?.shortValue == shortValue, "Result is not equal to initial short value")
            
            var dataResult: NSData? = nil
            ...
            XCTAssert(longResult?.longValue == longValue, "Result is not equal to initial long value")
        } catch let error as NSError {
            XCTFail("Failed with error: \(error.localizedDescription)")
        }
    }
